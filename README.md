...
**Python-To-Do-App-Cli** is a command-line interface application built with [Typer](https://typer.tiangolo.com/) to help you manage your to-do list.

## Installation

To run **Python-To-Do-App-Cli**, you need to run the following steps:
...
```sh
$ python -m app add --help
Usage: app add [OPTIONS] DESCRIPTION...
...
**Python-To-Do-App-Cli** has the following features:
